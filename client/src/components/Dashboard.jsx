...
const Dashboard = () => {
    return (
        <div className="bg-gray-200">
            <nav className="flex mx-4 pt-4 md:mt-0 md:mx-24 justify-between">
                <div><h1 className="uppercase font-bold text-dark-gray">Groupfind</h1></div>
                <div>
                    <ul className="flex space-x-6">
                        <li>
                            <a className="font-light" href="/dashboard">Dashboard</a>
                        </li>
                        <li>
                ...
                <div>
                    <button className="px-4 py-1 font-semibold rounded bg-black text-white">Log Out</button>
                </div>
            </nav>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start md:justify-between mx-4 mt-8 md:mx-24">
                <div className="flex">
                    <div className="h-12 w-12 rounded-full bg-gray-500">
                        <img className="h-12 w-12 rounded-full" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.2&w=160&h=160&q=80" alt=""/>
                    </div>
                    <div className="ml-2">
                        <h1 className="text-xl">John Doe</h1>
                        <p className="font-light uppercase text-xs text-dark-gray">Student</p>
                    </div>
                </div>
                <div className="mt-3">
                <div className="relative rounded-r w-108">
